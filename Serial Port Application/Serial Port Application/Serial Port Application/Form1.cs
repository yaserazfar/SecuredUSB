...
namespace Serial_Port_Application
{
    public partial class Form1 : Form
    {
        ...
        public static int UniqueUsbKey; //this is a key that will be given to every usb and is different for each usb *would potentially be in the cloud*
        ...
        private void port_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            if (recievedString == "1") //this is the integer used to represent when user is trying to sync usb
            {
                ...
                //need to add usb to the usb key list and send the usb key to the serial port for andriod app to read off of
            }
